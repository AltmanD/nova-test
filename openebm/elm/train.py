...
if __name__ == '__main__':
    ...
    parser.add_argument("--profile_training_pipeline", help="profile dataloader wait, packing, tokenization, forward/backward, and optimizer step timings during training", action="store_true", default=False)
