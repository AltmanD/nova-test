...
OPTION_FLAGS="--dynamic_wd --wd_decay_style cosine --linear_warmdown --warmup_ratio 0.0057 --warmdown_ratio 0.65 --final_lr_frac 0.05 \
--optimizer muon_adamw --muon_lr 0.02 --muon_momentum 0.97 --muon_ns_steps 5 --muon_beta2 0.95 \
--adamw_embedding_lr 0.3 --adamw_vocab_to_embed_lr 0.03 --adamw_scalar_lr 0.5 --adamw_dmodel_lr_scaling \
--muon_momentum_warmup_steps 400 --ffn_dim_multiplier 1.5"
# --ffn_dim_multiplier 2.67 理论最佳但 oom，1.5 不会oom
